...
class OneDTMatchs extends StatefulWidget {
  String date;
  OneDTMatchs({this.date});
  @override
  _OneDTMatchsState createState() => _OneDTMatchsState();
}

class _OneDTMatchsState extends State<OneDTMatchs> {
