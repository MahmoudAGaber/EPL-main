...
class TwoDTMatches extends StatefulWidget {
  String date;
  TwoDTMatches({this.date});
  @override
  _TwoDTMatchesState createState() => _TwoDTMatchesState();
}

class _TwoDTMatchesState extends State<TwoDTMatches> {
