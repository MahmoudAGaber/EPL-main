...
class TomorrowMatchs extends StatefulWidget {
  String date;
  TomorrowMatchs({this.date});
  @override
  _TomorrowMatchsState createState() => _TomorrowMatchsState();
}

class _TomorrowMatchsState extends State<TomorrowMatchs> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      //print(matchesViewModel.matchesList[0].comName);
    });
    super.initState();
  }
                            ...
                            itemBuilder: (widget, indexx) {
                              return GestureDetector(
                                ...
                                onTap: () {
                                  Navigator.push(context,
                                      MaterialPageRoute(
                                          builder: (context)=>ChangeNotifierProvider<EachMatchViewModel>(
