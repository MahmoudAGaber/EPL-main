...
class TwoDAMatchs extends StatefulWidget {
  String date;
  TwoDAMatchs({this.date});
  @override
  _TwoDAMatchsState createState() => _TwoDAMatchsState();
}

class _TwoDAMatchsState extends State<TwoDAMatchs> {
                        ...
                        onTap: (){
                          Navigator.push(context,
                              MaterialPageRoute(builder: (context)=> ChangeNotifierProvider<EachLeagueViewModel>(
                                  ...
                                  child: EachLeague(url: provider.matchesList[index].comURL,))));
                        },
                        ...
                        child: Row(
                          children: [
                            Container(
                                width: 35,
                                height: 30,
                                child:  provider.matchesList[index].comImg.endsWith('svg')
                                    ?SvgPicture.network("https://www.eplworld.com/${provider.matchesList[index].comImg}",semanticsLabel: 'Acme Logo')
                                    :Image.network("https://www.eplworld.com/${provider.matchesList[index].comImg}")
                            ),
                            SizedBox(
                              width: 10,
                            ),
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (widget, indexx) {
                            return GestureDetector(
                              ...
                              onTap: () {
                                Navigator.push(context,
                                    MaterialPageRoute(builder: (context)=>provider.matchesList[index].subOfMathes[indexx].status == "Played"
                                        ?ChangeNotifierProvider<EachMatchViewModel>(
                                      create: (_)=>EachMatchViewModel(),
                                      child: matchInfo_a(url: provider.matchesList[index].subOfMathes[indexx].matchURL,
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    provider.matchesList[index].subOfMathes[indexx].status =='Played'
                                                        ? Text(
                                                      "${provider.matchesList[index]
                                                          .subOfMathes[indexx].homeScore} - ${provider.matchesList[index]
                                                          .subOfMathes[indexx].awayScore}",
                                                      ...
                                                      style: TextStyle(fontSize: 14, color: Colors.black45,decoration: TextDecoration.lineThrough),)
                                                        :Container()
                                                  ],
                                                ),
