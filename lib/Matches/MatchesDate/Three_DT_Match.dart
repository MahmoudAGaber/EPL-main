...
class ThreeDTMatchs extends StatefulWidget {
  String date;
  ThreeDTMatchs({this.date});
  @override
  _ThreeDTMatchsState createState() => _ThreeDTMatchsState();
}

class _ThreeDTMatchsState extends State<ThreeDTMatchs> {
