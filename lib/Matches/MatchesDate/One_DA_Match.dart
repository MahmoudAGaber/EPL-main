...
class OneDAMatchs extends StatefulWidget {
  String date;
  OneDAMatchs({this.date});
  @override
  _OneDAMatchsState createState() => _OneDAMatchsState();
}

class _OneDAMatchsState extends State<OneDAMatchs> {
