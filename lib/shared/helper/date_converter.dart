...
class DateConverter {
  ...
  static DateTime convertStringToDatetime(String dateTime) {
    return DateFormat("yyyy-MM-ddTHH:mm:ss.SSS",'en').parse(dateTime);
  }
  ...
  static DateTime isoStringToLocalDate(String dateTime) {
    return DateFormat('yyyy-MM-ddTHH:mm:ss.SSS','en').parse(dateTime, true).toLocal();
  }
  ...
  static String isoStringToLocalTimeWithAMPMOnly(String dateTime) {
    return DateFormat('hh:mm a','en').format(isoStringToLocalDate(dateTime));
  }
  ...
  static String isoStringToLocalDateOnly2(String dateTime) {
    return DateFormat('yyyy-MM-dd','en').format(isoStringToLocalDate(dateTime));
  }
