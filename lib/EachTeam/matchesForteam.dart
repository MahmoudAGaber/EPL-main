                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child: Container(
                                                                          width: 33,
                                                                          height: 28,
                                                                          child: provider.recentMatche[index].matchInBoxModel[indexx].homeTeamLogo.endsWith('svg')
                                                                              ? SvgPicture.network("https://www.eplworld.com${provider.recentMatche[index].matchInBoxModel[indexx].homeTeamLogo}",
                                                                                  semanticsLabel: 'Acme Logo')
                                                                              : Image.network("https://www.eplworld.com${provider.recentMatche[index].matchInBoxModel[indexx].homeTeamLogo}"),
                                                                        ),
                                                                      ),
                                                                      provider.recentMatche[index].matchInBoxModel[indexx].periodId !=
                                                                              null
                                                                          ? Text(
                                                                              ...
                                                                              style: (provider.recentMatche[index].matchInBoxModel[indexx].status == "Fixture")
                                                                                  ? TextStyle(fontFamily: 'Vazirmatn', fontSize: 15, color: Colors.black)
                                                                                  : TextStyle(fontFamily: 'Vazirmatn', fontSize: 15, color: Colors.black54),
                                                                            )
                                                                          : Text(
                                                                              '__'),
                                                                      Padding(
                                                                    ...
                                                                    children: [
                                                                      Flexible(
                                                                        child: Text(
                                                                          ...
                                                                          style: TextStyle(
                                                                            fontFamily: 'Vazirmatn', fontSize: 14, fontWeight: FontWeight.w500,),
                                                                          overflow: TextOverflow.clip,textDirection: TextDirection.rtl,
                                                                        ),
                                                                      ),
                                                                    ],
                                                                  ),
