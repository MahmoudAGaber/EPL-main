                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  MainAxisAlignment.start,
                                  children: <Widget>[
                                    Text("نتائج الفرق".tr,style: Theme.of(context).textTheme.titleMedium,)
                                  ],
                                ),
                              ),
                              Divider(),
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          Text('belongsToName.tr',style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 13),)
                        ],
                      ),
                      Row(
                              children: <Widget>[
                                'home' == 'home'
                                    ? Text(
                                        " صانع الهدف : goalMakerName"
                                            .tr,
                                    style:Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 13)
                                      )
                                    : Text(
                                        " goalMakerName صانع الهدف : "
                                            .tr,
                                        style:Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 13)
                                      )
                              ],
                  ...
                  children: <Widget>[
                    ...
                    Stack(
                      children: [
                        Container(
                          height: 25,width: 25,
                          child: Image.asset("assets/penalty1.png",color: Colors.red ,),
                        ),
                      ],
                    ),
                    SizedBox(
