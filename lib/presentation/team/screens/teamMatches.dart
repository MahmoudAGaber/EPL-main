...
class MatchesForTeam extends ConsumerStatefulWidget {
  String? teamId;
  MatchesForTeam({this.teamId});
  @override
  _MatchesForTeamState createState() => _MatchesForTeamState();
}

class _MatchesForTeamState extends ConsumerState<MatchesForTeam> {
