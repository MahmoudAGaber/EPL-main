...
final newsProvider = StateNotifierProvider<NewsNotifier,StateModel<List<NewsModel>>>((ref) => NewsNotifier(ref));



class NewsNotifier extends StateNotifier<StateModel<List<NewsModel>>>{
  Ref ref;
  NewsNotifier(this.ref):super(StateModel.loading());
  int currentPage = 1;
  bool isLoading = false;
  bool hasMoreData = true;

  Future<void> getNews(int page, {bool isLoadMore = false}) async {
