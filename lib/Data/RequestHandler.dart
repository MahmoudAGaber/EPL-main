...
class RequestHandler{
  ...
  static const mainUrl = "https://www.eplworld.com/api";
   ...
   //Search
  Future<MainResponse> search({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
  ...
  //Matches
  Future<ResponseModel> getDataMatches({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
    ...
    switch (response.statusCode) {
      case 200:
        var responseJson = ResponseModel.Json(json.decode(response.body.toString()));
       // print(responseJson);
        return responseJson;
      case 400:
        throw BadRequestException(response.body.toString());
  ...
  //Matches
  Future<PlayerInf> getPlayerInfo({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
    ...
    switch (response.statusCode) {
      case 200:
        var responseJson = PlayerInf.fromJson(json.decode(response.body.toString()));
        // print(responseJson);
        return responseJson;
      case 400:
        throw BadRequestException(response.body.toString());
  ...
  Future<ResponseModelEachMatch> getEachMatch({endPoint,String parma=''}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
    ...
    switch (response.statusCode) {
      case 200:
        var responseJson = ResponseModelEachMatch.json(json.decode(response.body.toString()));
        //print(responseJson);
        return responseJson;
      case 400:
        throw BadRequestException(response.body.toString());
  ...
  //Leagues
  Future <List<ResponseModelLeagues>> getDataLeagues({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
...
//oneLeague
  Future<MainResponse> getDataOneLeagues({endPoint,String parma='',context}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
    ...
    switch (response.statusCode) {
      case 200:
        mainResponse.data= ResponseModelOneLeague.json(json.decode(response.body.toString()));
        mainResponse.msg = 'Success';
        //print(mainResponse);
        return mainResponse;
      case 400:
  ...
  Future<MainResponse> getEachTeam({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
    ...
    switch (response.statusCode) {
      case 200:
        mainResponse.data= ResponseModelEachTeam.json(json.decode(response.body.toString()));
        mainResponse.msg = 'Success';
        //print(mainResponse);
        return mainResponse;
      case 400:
  ...
  Future<ResponseModelSquadTeam> getSquadTeam({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
  ...
  Future<ResponseModelCups> getCups({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
  ...
  Future<ResponseModelLeagueCups> getLeaguesCups({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
  ...
  Future<MainResponse> getTransfers({endPoint,String parma='',context}) async {
    String msg;
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
    ...
    switch (response.statusCode) {
      case 200:
         mainResponse.data= ResponseModelTransfers.json(json.decode(response.body.toString()));
         mainResponse.msg = 'Success';
        print(mainResponse);
        return mainResponse;
      case 400:
  ...
  Future<MainResponse> getHTHMatchData({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
    ...
    switch (response.statusCode) {
      case 200:
        mainResponse.data= ResponseModelHeadToHead.json(json.decode(response.body.toString()));
        mainResponse.msg = 'Success';
        //print(mainResponse);
        return mainResponse;
      case 400:
  ...
  Future<ResponseModelEvents> getMatchEndEvent({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
  ...
  Future<ResponseModelNews> getNews({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
  ...
  Future<ResponseModelVideos> getVideos({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
  ...
  Future<ResponseModelEachPlayer> getEachPlayer({endPoint,String parma='',}) async {
    Response response  = await http.get(
        Uri.parse(mainUrl + endPoint  + parma),
        headers:{
          "Content-Type" : "application/json; charset=UTF-8"
